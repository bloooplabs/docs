...
$BLP was launched via **Pump.fun** as an initial distribution and liquidity bootstrap mechanism.
...
Post-launch liquidity follows the standard Pump lifecycle.

---

## Creator Rewards → Ecosystem Funding

Creator rewards generated during the Pump.fun lifecycle are allocated toward building Blooop itself.

These funds function as ecosystem fuel — not extraction.
...
> Market activity helps fund product development.
